...
import com.orion31.Obsidian.player.*;
...
import static com.orion31.Obsidian.Messenger.*;
    ...
    public void onEnable() {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            try {
                ...
                oPlayer.setTag(yml.getString(oPlayer.getRealName() + ".settings.tag"));
        ...
        for (ObsidianPlayer p : getObsidianPlayers()) {
            NameTagChanger.INSTANCE.changePlayerName(p.getMirror(), p.getTag());
        }
